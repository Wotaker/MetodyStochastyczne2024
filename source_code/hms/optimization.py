...
def hms_optimization(x_train, y_train, x_test, y_test):
    ...
    config = [
        EALevelConfig(ea_class=SEA, generations=4, problem=gpr_problem, pop_size=10, mutation_std=1515,
                      lsc=DontStop()),
        EALevelConfig(ea_class=SEA, generations=8, problem=gpr_problem, pop_size=20, mutation_std=1,
                      sample_std_dev=0.01, lsc=DontStop()),
    ]
